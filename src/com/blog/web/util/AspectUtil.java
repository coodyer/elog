...
public class AspectUtil {
	...
	public static Object getMethodPara(Method method, String fieldName,
			Object[] args) {
		List<BeanFieldEntity> BeanFieldEntitys = PropertUtil.getMethodParas(method);
		if (StringUtils.isNullOrEmpty(BeanFieldEntitys)) {
			return "";
		}
		String[] fields = fieldName.split("\\.");
		BeanFieldEntity entity = (BeanFieldEntity) PropertUtil.getByList(
				BeanFieldEntitys, "fieldName", fields[0]);
		if (StringUtils.isNullOrEmpty(entity)) {
			return "";
		}
		Object para = args[BeanFieldEntitys.indexOf(entity)];
