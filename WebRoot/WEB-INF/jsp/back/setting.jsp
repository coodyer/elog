					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="user-email" value="${setting.keywords }"
										name="setting.keywords" datatype="*2-100"
										placeholder="请输入网站关键字" errormsg="请输入正确的网站关键字(2-100位)"
										sucmsg="输入正确" nullmsg="请输入网站关键字">
								</div>
							</div>
